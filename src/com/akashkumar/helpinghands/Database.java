...
public class Database extends SQLiteOpenHelper {
	private static final String DATABASE_PATH = "/data/data/com.akashkumar.helpinghands/databases/";
	private static final String DATABASE_NAME = "HelpingHandsDatabase";
